...
lsu <- readRDS("output/sub1K-lsu/phyloseq/LSU/pooled_reads/blast/pooled_reads.phyloseq.rds")
...
plot_grid(
  ...
  phylum_bar_plot(full_its_old_fungi),
  labels = c("its1", "its2", "full its", "full its (old)"))
